...
const OBJ_PATH = 'evidence/VAL-G2-2026-08-28/canonical-core-val-r0/J1_GT-USB-7005A.easyeda-zup-yflip.obj';
const STL_PATH = 'evidence/VAL-G2-2026-08-28/dec-usb-hub/3d/J1_GT-USB-7005A.stl';
const OUT = 'evidence/VAL-G2-2026-08-28/canonical-core-val-r0/u1-gtusb-3d-yflip-bind-2026-08-30.json';
...
const result = await evaluate(`(async () => {
  ...
  if (modelUuid) {
    try { out.renamed = await R.lib_3DModel.modify(modelUuid, personal, title, classif, 'D-050 GT-USB-7005A seating-plane rebuild; Z=0 PCB top; mm'); }
