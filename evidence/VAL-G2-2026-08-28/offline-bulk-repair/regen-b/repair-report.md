...
- Output SHA256: `3db861a351239a8628b151c4610a845da761ed9bcb562755f9ea9374aa262ba7`
- Validation: **PASS**
- PCB payload: **UNCHANGED / still empty**
- Schematic primitive components: 255
...
- **RQ-025** — `PARTIAL_G3` — U1 PG and R67 share PWR_ENTRY_PG_RT_IOMUX_TBD; RT ball deferred per VAL-G3 pinmux rule
...
- **RQ-035** — `APPLIED` — external clock override no longer disables RT capture; R31, R32 and R33 remain fitted
...
- **RQ-047** — `SUPERSEDED_BY_U4_REMOVAL` — R8-PWR2 removed with shared LED eFuse; U17 ILIM is RILIM-LED, not a 3.48k bind
...
- **RQ-053** — `APPLIED_WITH_EXPLICIT_HOLDS` — normalized instance supplier IDs from project-device LCSC authority; changed fields=314, local/TUNE devices without real C-code held=26
