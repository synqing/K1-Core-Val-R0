...
const OUT = '/Users/spectrasynq/Workspace_Management/Software/K1-CORE-VAL-R0/evidence/VAL-G2-2026-08-28/dec-usb-hub/screenshots/T00d2-j1-pwr1-tight.png';
...
if (!String(page.url).includes(HUB)) {
	throw new Error('CDP page is not hub project: ' + page.url);
}
...
const fired = await evalPage(`(() => {
	...
	try { void eda.dmt_EditorControl.zoomTo(-485, 3160, 140, tab); } catch (e) {}
	return { ok: true, urlHint: location.href.slice(0, 120) };
})()`);
