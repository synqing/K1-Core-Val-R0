...
const OUT = process.env.SHOT_OUT || '/Users/spectrasynq/Workspace_Management/Software/K1-CORE-VAL-R0/evidence/VAL-G2-2026-08-28/dec-usb-hub/screenshots/T04-hub-support-designate.png';
...
const fired = await evalPage(`(() => {
	...
	try { eda.sch_SelectControl.doSelectPrimitives(["92edd0bd8901c171","736247481f2dd650"], tab); } catch (e) {}
	try { void eda.dmt_EditorControl.zoomTo(500, 950, 55, tab); } catch (e) {}
	return { ok: true };
})()`);
